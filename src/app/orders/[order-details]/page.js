...
export default function OrderDetails() {
  ...
  return (
    <div className="py-14 px-4 md:px-6 ">
      ...
      <div className="mt-10 flex flex-col justify-center xl:flex-row items-stretch w-full xl:space-x-8 md:space-y-6 xl:space-y-0 text-black">
        <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
          <div className="flex flex-col justify-start items-start bg-gray-50 px-4 py-4 md:p-6 xl:p-8 w-full">
            <p className="font-bol text-lg font-bold ">Your order summary</p>
            {orderDetails &&
